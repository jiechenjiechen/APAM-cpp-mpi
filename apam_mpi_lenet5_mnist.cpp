// LeNet-5 neural network on MNIST data set.
...
int main(int argc, char **argv) {
  ...
  std::string debug_sparse_outfile = "debug_lenet5_sparse.txt";
  ...
  std::string debug_time_outfile = "debug_lenet5_time.txt";
  bool debug_grad = false;   // if true, debugging info will print to file
  std::string debug_grad_outfile = "debug_lenet5_grad.txt";
  ...
  LeNet5 model;                           // move net to device
  model.to(device);
  APAM<LeNet5> optimizer(model, lr, use_amsgrad, use_sparse); // set optimizer
